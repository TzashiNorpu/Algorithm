...
class LeetCode_3_127Test {
    ...
    void ladderLength() {
        ...
        System.out.printf("ladderLength4 result=%d\n", instance.ladderLength4(beginword1, endword1, wordlist1));
        System.out.println("-----------------------------");
        ...
        System.out.printf("ladderLength4 result=%d\n", instance.ladderLength4(beginword2, endword2, wordlist2));
        System.out.println("-----------------------------");
        ...
        System.out.printf("ladderLength4 result=%d\n", instance.ladderLength4(beginword3, endword3, wordlist3));
        System.out.println("-----------------------------");
        ...
        System.out.printf("ladderLength4 result=%d\n", instance.ladderLength4(beginword4, endword4, wordlist4));
    }
}